...
void displayInitFFT(bool reset) {
    ...
    for (uint16_t y = 0; y < 275; y++) {
        ...
        if (dB != dBPre) {
            ...
            if (dB == -5) { bg.drawText("5", iVec2(223, 319 - y), FFT_ScaleForeColor, Arial_8, false); }
            if (dB == -10) { bg.drawText("10", iVec2(220, 319 - y), FFT_ScaleForeColor, Arial_8, false); }
            if (dB == -20) { bg.drawText("20", iVec2(220, 319 - y), FFT_ScaleForeColor, Arial_8, false); }
            if (dB == -30) { bg.drawText("30", iVec2(220, 319 - y), FFT_ScaleForeColor, Arial_8, false); }
            if (dB == -40) { bg.drawText("40", iVec2(220, 319 - y), FFT_ScaleForeColor, Arial_8, false); }
            dBPre = dB;
        }
    }
    ...
    if ((FFT_LevelBarMode == 0 /*PEAK*/) ? peak1.available() : rms1.available()) {
        ...
        for (uint16_t y = 0; y < 275; y++) {
            ...
            if (dB != dBPre) {
                ...
                if (dB == -5.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -10.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -15.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -20.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -25.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -30.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -35.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -40.0f) { im.drawFastHLine(214, 315 - y, 4, FFT_VUMarkerColor); }
                dBPre = dB;
            }
        }
        return barVal;
    ...
    if ((FFT_LevelBarMode == 0 /*PEAK*/) ? peak2.available() : rms2.available()) {
        ...
        for (uint16_t y = 0; y < 275; y++) {
            ...
            if (dB != dBPre) {
                ...
                if (dB == -5.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -10.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -15.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -20.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -25.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -30.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -35.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                if (dB == -40.0f) { im.drawFastHLine(233, 315 - y, 4, FFT_VUMarkerColor); }
                dBPre = dB;
            }
        }
        return barVal;
